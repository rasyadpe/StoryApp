...
export default function AddGuestStoryPage() {
  const storyPresenter = new StoryPresenter();
  let mediaStream = null;
  
  document.querySelector('#main-content').innerHTML = `
    <div class="container">
      <h1 class="page-title">Add New Story as Guest</h1>
  ...
  form.addEventListener('submit', async (event) => {
    ...
    try {
      ...
      await storyPresenter.addGuestStory(formData); // Changed to addGuestStory
      stopCameraStream();
      closeLoading();
